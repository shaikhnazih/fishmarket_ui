...
{
    const user = useSelector(({ feedbacksApp }) => feedbacksApp.user);
                ...
                <Paper className="rounded-0 shadow-none lg:rounded-8 lg:shadow-1">
                    ...
                    <List>
                        <ListItem
                            ...
                            to={'/apps/feedbacks/all'}
                            activeClassName="active"
                            className={classes.listItem}
                        >
                            <Icon className="list-item-icon text-16" color="action">people</Icon>
                            <ListItemText className="truncate" primary="All feedbacks" disableTypography={true}/>
                        </ListItem>
                        <ListItem
                            button
                            component={NavLinkAdapter}
                            to={'/apps/feedbacks/frequent'}
                            activeClassName="active"
                            className={classes.listItem}
                        >
                            <Icon className="list-item-icon text-16" color="action">restore</Icon>
                            <ListItemText className="truncate" primary="Frequently feedbacked" disableTypography={true}/>
                        </ListItem>
                        <ListItem
                            button
                            component={NavLinkAdapter}
                            to={'/apps/feedbacks/starred'}
                            activeClassName="active"
                            className={classes.listItem}
                        >
                            <Icon className="list-item-icon text-16" color="action">star</Icon>
                            <ListItemText className="truncate" primary="Starred feedbacks" disableTypography={true}/>
                        </ListItem>
                    </List>
                </Paper>
            </FuseAnimate>

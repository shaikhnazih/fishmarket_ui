...
function FeedbackCategoryHeader(props) {
            ...
            <div className="flex flex-shrink items-center sm:w-224">
                ...
                <div className="flex items-center">
                    ...
                    <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                        <Typography variant="h6" className="mx-12 hidden sm:flex">Feedback Category</Typography>
                    </FuseAnimate>
                </div>
            </div>
...
export default FeedbackCategoryHeader;

...
function GiftsHeader(props) {
    ...
    function setFile(e) {
        ...
        excel.append('type', 'GiftBulkUpload');
    ...
    useEffect(() => {
        ...
        if (file != null && (file.fileName.split('.')[1] == 'xls' || file.fileName.split('.')[1] == 'xlsx')) {
            dispatch(RootActions.showMessage({ message: "Bulk Upload Started....", variant: 'success' }))
            Actions.giftBulkUpload(file.fileName);
            setForm({
                ...form,
            ...
            <div className="flex flex-shrink items-center sm:w-224">
                ...
                <div className="flex items-center">
                    ...
                    <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                        <Typography variant="h6" className="mx-12 hidden sm:flex">Gifts</Typography>
                    </FuseAnimate>
                </div>
            </div>

                ...
                <Paper className="rounded-0 shadow-none lg:rounded-8 lg:shadow-1">
                    ...
                    <List>
                        ...
                        >
                            ...
                            <ListItemText className="truncate" primary="All users" disableTypography={true} />
                        </ListItem>
                        <ListItem
                            button
                            component={NavLinkAdapter}
                        ...
                        >
                            ...
                            <ListItemText className="truncate" primary="Frequently usered" disableTypography={true} />
                        </ListItem>
                        <ListItem
                            button
                            component={NavLinkAdapter}
                        ...
                        >
                            ...
                            <ListItemText className="truncate" primary="Starred users" disableTypography={true} />
                        </ListItem>
                    </List>
                </Paper>
            </FuseAnimate>

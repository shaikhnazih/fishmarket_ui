...
function SchemeSidebarContent(props)
{
                ...
                <Paper className="rounded-0 shadow-none lg:rounded-8 lg:shadow-1">
                    ...
                    <List>
                        ...
                        >
                            ...
                            <ListItemText className="truncate" primary="All schemes" disableTypography={true}/>
                        </ListItem>
                        <ListItem
                            button
                            component={NavLinkAdapter}
                            to={'/apps/scheme/frequent'}
                            activeClassName="active"
                            className={classes.listItem}
                        >
                            <Icon className="list-item-icon text-16" color="action">restore</Icon>
                            <ListItemText className="truncate" primary="Frequently schemeed" disableTypography={true}/>
                        </ListItem>
                        <ListItem
                            button
                            component={NavLinkAdapter}
                            to={'/apps/scheme/starred'}
                            activeClassName="active"
                            className={classes.listItem}
                        >
                            <Icon className="list-item-icon text-16" color="action">star</Icon>
                            <ListItemText className="truncate" primary="Starred schemes" disableTypography={true}/>
                        </ListItem>
                    </List>
                </Paper>
            </FuseAnimate>
...
export default SchemeSidebarContent;
